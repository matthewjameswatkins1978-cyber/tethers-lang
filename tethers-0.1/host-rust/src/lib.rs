...
pub mod replay;
mod replay_runtime;
#[cfg(windows)] pub mod replay_windows;
pub mod resolver;
mod result_anchor;
pub mod run_command;
pub mod run_input;
...
pub(crate) use application::{
    ...
    inject_bridge_projection_into_request, now_unix_ms, request_exact_approval,
    InputEventContext, ResponseResultAnchorWriter, SharedExecutionOutcome,
