...
- **Replay Ledger is the ONLY store with directory-entry durability**: It calls `FlushFileBuffers` AFTER rename, which pushes the directory metadata. All other stores only flush file data.
