...
the released 0.8.0 authority and execution boundary.**
...
The 0.8.0 line adds the versioned external Authority Gate, reusable Rust crate,
and separately installable Windows runtime without expanding Core semantics.
