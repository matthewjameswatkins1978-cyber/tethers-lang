...
| Audit HEAD | `89475ad18bb48aa768157cf49898272ffa4581b0` |
| `origin/main` at audit | `699f9c8f48359b8b3de0d3614b8827acecf977cf` |
| Audit divergence | `5 ahead / 0 behind` |
...
closeout branch now contains five history-preserving commits, ready for the
...
The audit branch preserves five history-preserving commits: the earlier test
